namespace ScpImmersiveVoice.EventHandlers
{
    ...
    public class ScpVoiceEventHandler
    {
        ...
        /// </summary>
        private readonly Dictionary<string, Scp096VoiceStateController> _scp096State = new Dictionary<string, Scp096VoiceStateController>();
        public Dictionary<string, Scp096VoiceStateController> Scp096States => _scp096State;
        private Scp096VoiceStateController Get096State(Player player)
        {
            if (!_scp096State.TryGetValue(player.UserId, out var controller))
            {
                controller = new Scp096VoiceStateController();
                _scp096State[player.UserId] = controller;
            }
        ...
        /// The key of this dictionary is UserId.
        /// </summary>
        private readonly Dictionary<string, Scp939VoiceStateController> _scp939State = new Dictionary<string, Scp939VoiceStateController>();


        public Dictionary<string, Scp939VoiceStateController> Scp939States => _scp939State;

        private Scp939VoiceStateController Get939State(Player player)
        {
            if (!_scp939State.TryGetValue(player.UserId, out var controller))
            {
                controller = new Scp939VoiceStateController();
                _scp939State[player.UserId] = controller;
            }
        ...
        private readonly Dictionary<string, Scp3114VoiceStateController> _scp3114State = new Dictionary<string, Scp3114VoiceStateController>();

        /// <summary>
        /// The key of this dictionary is PlayerId.
        /// </summary>
        public Dictionary<string, Scp3114VoiceStateController> Scp3114States => _scp3114State;

        private Scp3114VoiceStateController Get3114State(Player player)
        {
            if (!_scp3114State.TryGetValue(player.UserId, out var controller))
            {
                controller = new Scp3114VoiceStateController();
                _scp3114State[player.UserId] = controller;
            }
