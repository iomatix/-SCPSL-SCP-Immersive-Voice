namespace ScpImmersiveVoice.EventHandlers
{
    ...
    public class Scp096AudioHandler
    {
        ...
        public ConcurrentDictionary<int, Scp096VoiceStateController> States => _states;

        private Scp096VoiceStateController GetState(Player player)
        {
            if (player == null) return null;
            return _states.GetOrAdd(player.PlayerId, _ => new Scp096VoiceStateController());
        }
